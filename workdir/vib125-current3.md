...
| 6 | UI spec, design-system gap list, HTML handoff, motion spec | UI & Wireframe Designer | **todo (promoted)** |
...
**Note:** Stage 1 authored by Design Lead, 2026-08-16. Gate 1 ([VIB-126](mention://issue/6e4c65c6-2242-47e3-a7bb-3182a14147e9)) approved same day — 4 defaults accepted (Home widget entry, block/RESTRICT delete, fixed-interval SRS, soft-cap queue). Stage 3 ([VIB-127](mention://issue/7e4baeed-e7cc-446d-aad1-59b865d6b981)) delivered full IA/flows. Stage 4a ([VIB-128](mention://issue/4faef63a-6c8a-45ac-b241-e6fdf85453a8)) delivered wireframes/state matrix/responsive rules; Stage 4b ([VIB-129](mention://issue/76b1d934-fac9-444c-b336-f5d8e2d42f89)) delivered content copy/error matrix. Gate 2 ([VIB-130](mention://issue/a56bcabd-503d-4766-8d8b-e1e599afb4d7)) approved same day — 2 more defaults accepted (no exit-confirmation on SCR-05, blocking first-save disclosure with cancel). Stage 6 ([VIB-131](mention://issue/58e3a917-c023-4347-93d5-648865def4d1)) promoted to `todo` for UI & Wireframe Designer — UI spec, design-system gap list, HTML handoff, motion spec.