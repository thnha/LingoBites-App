 ...
 * Animated.View, Easing, useAnimatedStyle, useReducedMotion, useSharedValue,
 * withTiming. Extend only when a component needs more.
 */
...
module.exports = {
  __esModule: true,
  default: {View, Text, Image, ScrollView, FlatList},
  View,
  Text,
  Image,
  ScrollView,
